...
* It's done when, if the contact link is clicked, the page jumps directly to the contact form.--------- button focus -----------
...
* It's done when the page is deployed to GitHub Pages.  ----- 1st setup Done - double checked? -----
